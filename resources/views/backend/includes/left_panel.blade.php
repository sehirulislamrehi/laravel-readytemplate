<div class="br-logo">
     <a href="{{ route('dashboard') }}">
          <img src="{{ asset(get_logo()) }}" class="img-fluid" style="width:50%; display: block; margin: 0 auto;"
               alt="Logo">
     </a>
</div>
<div class="br-sideleft sideleft-scrollbar">
     ...
     <ul class="br-sideleft-menu">
          ...
          <li class="br-menu-item">
               <a href="#" class="br-menu-link with-sub {{ get_sub_module($module,Route::currentRouteName()) }}">
