                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="row tab-pane active" id="basic_information">
                                <form class="ajax-form" method="post" enctype="multipart/form-data" @if(auth('super_admin')->
                                    check())
                                    ...
                                    <div class="col-auto form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Name" @if( auth('super_admin')->check() )
                                    ...
                                    <div class="col-auto form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="email" name="email" class="form-control" placeholder="Email" @if( auth('super_admin')->check() )
                                    ...
                                    <div class="col-auto form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" name="phone" class="form-control" placeholder="Phone" @if(auth('super_admin')->check() )
                                    ...
                                    <div class="col-auto form-group">
                                        <div class="dropify-wrapper">
                                            ...
                                            <div class="dropify-errors-container">
                                                <ul></ul>
                                            </div><input type="file" id="input-file-now" class="dropify" name="image" data-default-file=""><button type="button" class="dropify-clear">Remove</button>
